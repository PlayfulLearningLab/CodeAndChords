 ...
 *
 */
public class ModuleTemplate_01_02_rev01 {
	...
	public ModuleTemplate_01_02_rev01(PApplet parent, MicrophoneInput input, String sidebarTitle)
	{
		this.parent	= parent;
		this.input	= input;
		...
		this.curColorStyle	= ModuleTemplate_01_02_rev01.CS_RAINBOW;
		...
		//TODO: make initModuleTemplate_01_02_rev01() private again, once it can be called from constructor.
		//this.initModuleTemplate_01_02_rev01();
	} // ModuleTemplate_01_02_rev01
	 ...
	 */
	public void initModuleTemplate_01_02_rev01()
	{
	...
	} // initModuleTemplate_01_02_rev01
	...
	private void addColorStyleButtons(int colorStyleY)
	{
		...
		.setGroup("sidebarGroup")
		.setInternalValue(ModuleTemplate_01_02_rev01.CS_RAINBOW);
		...
		.setGroup("sidebarGroup")
		.setInternalValue(ModuleTemplate_01_02_rev01.CS_DICHROM);
		...
		.setGroup("sidebarGroup")
		.setInternalValue(ModuleTemplate_01_02_rev01.CS_TRICHROM);
		...
		.setGroup("sidebarGroup")
		.setInternalValue(ModuleTemplate_01_02_rev01.CS_CUSTOM);
	...
	private void updateColors(float colorStyle)
	{
		...
		// Rainbow:
		if(this.curColorStyle == ModuleTemplate_01_02_rev01.CS_RAINBOW)
		{
		...
		// Dichromatic:
		if(this.curColorStyle == ModuleTemplate_01_02_rev01.CS_DICHROM)
		{
		...
		// Trichromatic:
		if(this.curColorStyle == ModuleTemplate_01_02_rev01.CS_TRICHROM)
		{
		...
		// Custom:
		if(this.curColorStyle == ModuleTemplate_01_02_rev01.CS_CUSTOM)
		{
	...
	public String[] getScale(String key, int majMinChrom)
	{
		...
		if(keyPos == -1) {
			throw new IllegalArgumentException("ModuleTemplate_01_02_rev01.getScale: key " + key + " is not a valid key.");
		}
		/*
	...
	{*/
		...
		if(keyPos > majorScales.length) {
			throw new IllegalArgumentException("ModuleTemplate_01_02_rev01.getScale(int, int): int param " + keyPos + " is greater than majorScales.length (" + majorScales.length + ").");
		}
	...
	private void applyColorModulate(float[][] colors, float[][] originalColors)
	{
		if(colors == null || originalColors == null) {
			throw new IllegalArgumentException("ModuleTemplate_01_02_rev01.applyColorModulate: one of the float[] parameters is null (colors = " + colors + "; originalColors = " + originalColors);
		} // error checking
	...
	{
		//System.out.println("ModuleTemplate_01_02_rev01: theControlEvent.getController() = " + controlEvent.getController());
		...
		if(id % 2 == 1 && id < sliderCutoff && id > 0)
		{
			...
			try	{
				...
				//System.out.println("ModuleTemplate_01_02_rev01.controlEvent: string value " + curTextfield.getStringValue() + 
		...
		if(controlEvent.getId() > 23 && (controlEvent.getId() % 3 == 1))
		{
			...
			else
			{
				...
				if(notePos < 0 || notePos > this.colors.length)	{
					throw new IllegalArgumentException("ModuleTemplate_01_02_rev01.controlEvent - custom color Textfields: " +
	...
	private void fillOriginalColors()
	{
		if(this.colors == null)
		{
			throw new IllegalArgumentException("ModuleTemplate_01_02_rev01.fillOriginalColors: this.colors is null.");
		}
	...
	private	void fillHSBColors()
	{
		if(this.colors == null)
		{
			throw new IllegalArgumentException("ModuleTemplate_01_02_rev01.fillHSBColors: this.colors is null.");
		}
	...
	private	int	calculateNotePos(int id)
	{
		...
		if(id > 63)
		{
			// Canvas:
			if(id == 64)	{
				throw new IllegalArgumentException("ModuleTemplate_01_02_rev01.calculateNotePos(int): id 64 should not be passed to this function, as it does not correspond to a note.");
			}
			...
			if(id == 69)
			{
				...
				} else if(this.curColorStyle == ModuleTemplate_01_02_rev01.CS_TRICHROM)
				{
	...
	public float getAttackReleaseTransition(int arORt)
	{
		...
		{
			throw new IllegalArgumentException("ModuleTemplate_01_02_rev01.getAttackReleaseTransition: parameter " + arORt + " is not a valid position in the array this.attackReleaseTransition.");
		} // error checking
