...
public abstract class ModuleTemplate {
	...
	public ModuleTemplate(PApplet parent, MicrophoneInput input, String sidebarTitle)
	{
		this(parent, input, sidebarTitle, 0, 0, parent.width, parent.height, 0);
	} // Constructor - PApplet, Input, String
	
	public ModuleTemplate(PApplet parent, MicrophoneInput input, String sidebarTitle, int leftEdgeX, int topYVal, int rectWidth, int rectHeight, int modTempNum)
	{
