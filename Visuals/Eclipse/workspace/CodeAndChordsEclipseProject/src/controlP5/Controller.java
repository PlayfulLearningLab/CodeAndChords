...
public abstract class Controller< T > implements ControllerInterface< T > , CDrawable , ControlP5Constants {
	...
	// isClickable allows things to be both invisible and clickable
...
//		if ( isVisible && ( isMousePressed == _myControlWindow.mouselock ) ) {
		if ( ( isClickable || isVisible) && ( isMousePressed == _myControlWindow.mouselock ) ) {
	...
	/**
	 * Addition to allow Controllers  to be invisible and still clickable.
	 * 
	 * @return instance variable isClickable
	 */
	...
	/**
	 * Setter for isClickable;
	 * returning me to fit with all the other methods.
	 * 
	 * @param clickable
	 * @return
	 */
	public T setClickable(final boolean clickable)
	{
