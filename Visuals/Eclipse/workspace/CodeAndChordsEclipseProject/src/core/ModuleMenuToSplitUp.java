...
public class ModuleMenuToSplitUp extends MenuTemplate  {
	 ...
	 */
	public ModuleMenuToSplitUp(PApplet parent, Module module, Input input, int totalNumColorItems)
	{
	...
	public void addColorStyleButtons(int xVal, int colorStyleY, String tabName)
	{
		...
		.moveTo(tabName)
		.setInternalValue(ModuleMenuToSplitUp.CS_RAINBOW);
		...
		.moveTo(tabName)
		.setInternalValue(ModuleMenuToSplitUp.CS_DICHROM);
		...
		.moveTo(tabName)
		.setInternalValue(ModuleMenuToSplitUp.CS_TRICHROM);
		...
		.moveTo(tabName)
		.setInternalValue(ModuleMenuToSplitUp.CS_CUSTOM);
	...
	public void controlEvent(ControlEvent controlEvent)
	{
		...
		if(controlEvent.isTab())
		{
			...
			if(controlEvent.getName() == "inputSelectDropdown")
			{
				...
				if(this.curColorStyle[this.currentInput] == ModuleMenuToSplitUp.CS_RAINBOW)
				{
					this.controlP5.getController("rainbow").update();
				}
				if(this.curColorStyle[this.currentInput] == ModuleMenuToSplitUp.CS_DICHROM)
				{
					this.controlP5.getController("dichrom").update();
				}
				if(this.curColorStyle[this.currentInput] == ModuleMenuToSplitUp.CS_TRICHROM)
				{
					this.controlP5.getController("trichrom").update();
				}
				if(this.curColorStyle[this.currentInput] == ModuleMenuToSplitUp.CS_CUSTOM)
				{
