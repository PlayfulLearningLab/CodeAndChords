 ...
 *
 */
public class ModuleTemplate_01_04 {
	...
	public ModuleTemplate_01_04(PApplet parent, Input input, String sidebarTitle)
	{
		this.parent	= parent;
		this.input	= input;
		...
		this.curColorStyle	= ModuleTemplate_01_04.CS_RAINBOW;
	...
	private void addColorStyleButtons(int colorStyleY)
	{
		...
		.setGroup("sidebarGroup")
		.setInternalValue(ModuleTemplate_01_04.CS_RAINBOW);
		...
		.setGroup("sidebarGroup")
		.setInternalValue(ModuleTemplate_01_04.CS_DICHROM);
		...
		.setGroup("sidebarGroup")
		.setInternalValue(ModuleTemplate_01_04.CS_TRICHROM);
		...
		.setGroup("sidebarGroup")
		.setInternalValue(ModuleTemplate_01_04.CS_CUSTOM);
	...
	private void updateColors(float colorStyle)
	{
		...
		// Rainbow:
		if(this.curColorStyle == ModuleTemplate_01_04.CS_RAINBOW)
		{
		...
		// Dichromatic:
		if(this.curColorStyle == ModuleTemplate_01_04.CS_DICHROM)
		{
		...
		// Trichromatic:
		if(this.curColorStyle == ModuleTemplate_01_04.CS_TRICHROM)
		{
		...
		// Custom:
		if(this.curColorStyle == ModuleTemplate_01_04.CS_CUSTOM)
		{
	...
	private	int	calculateNotePos(int id)
	{
		...
		if(id > 63)
		{
			...
			if(id == 69)
			{
				...
				} else if(this.curColorStyle == ModuleTemplate_01_04.CS_TRICHROM)
				{
