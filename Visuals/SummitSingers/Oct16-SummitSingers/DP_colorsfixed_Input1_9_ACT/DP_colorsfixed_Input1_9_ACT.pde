...
void draw()
{
  ...
  {
    fill(45-colorDecay*oldPurple, 0-colorDecay*oldPurple, 255-colorDecay*oldPurple); //122 73 155 (45 0 255 was indigo)
...
//  int volPink  = round(pinkVol);
  ...
  for (j=0; j<volPink; j++)
  {
    fill(255-colorDecay*oldPink, 0-colorDecay*oldPink, 222-colorDecay*oldPink); //255 130 180 (255 0 222 was fuchsia)
