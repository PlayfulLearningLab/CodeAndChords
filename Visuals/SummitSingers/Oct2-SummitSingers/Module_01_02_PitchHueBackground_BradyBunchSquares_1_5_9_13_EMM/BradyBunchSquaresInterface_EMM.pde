abstract class BradyBunchSquares
{
  ...
  BradyBunchSquares(int numSquares)
  {
    int  rows;
    ...
    if (this.numSquares < 3) {
      ...
      throw new IllegalArgumentException("BradyBunchSquares.constructor: numSquares is = " + numSquares + "; must be less than or equal to 9.");
    } // else
