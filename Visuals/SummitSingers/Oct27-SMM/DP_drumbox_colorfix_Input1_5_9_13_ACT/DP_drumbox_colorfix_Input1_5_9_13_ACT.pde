...
//    if(myIns.getAmplitude(14) > 100)
    ...
    for (j=0; j<volb1; j++)
    {
      fill(255-colorDecay*oldb1, 0, 0); //224 36 71 (255 0 0)
    ...
    for (j=0; j<volb2; j++)
    {
      fill(255-colorDecay*oldb2, 145-colorDecay*oldb2, 0); //255 90 8 (255 145 0)
    ...
    for (j=0; j<volt2; j++)
    {
      fill(41-colorDecay*oldt2, 255-colorDecay*oldt2, 0); //162 211 2 (41 255 0)
    ...
    {
      fill(0, 255-colorDecay*oldForestGreen, 232-colorDecay*oldForestGreen); //1 100 65 (0 255 232 was CYAN)
      ...
      oldForestGreen=oldForestGreen+pitchForestGreen/(Math.max(pitchForestGreen+1, 1));
    }
    oldt2=pitcht2/(volt2+1);
    ...
    {
      fill(0-colorDecay*oldPeriwinkle, 129-colorDecay*oldPeriwinkle, 255-colorDecay*oldPeriwinkle); //149 176 250 (0 129 255)
    ...
    {
      fill(45-colorDecay*oldPurple, 0, 255-colorDecay*oldPurple); //122 73 155 (45 0 255 was indigo)
    ...
    {
      fill(139-colorDecay*oldFuchsia, 0, 255-colorDecay*oldFuchsia); //247 3 222 (139 0 255 was purple)
    ...
    for (j=0; j<volPink; j++)
    {
      fill(255-(colorDecay/2)*oldPink, 0, 222-(colorDecay/2)*oldPink); //255 130 180 (255 0 222 was fuchsia)
