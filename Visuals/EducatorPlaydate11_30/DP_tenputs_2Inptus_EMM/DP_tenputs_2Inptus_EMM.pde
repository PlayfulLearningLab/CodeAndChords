...
void draw()
{
  ...
  float ypvol = myIns.getAmplitude(1) / volAdjust;
  //  float ypvol = t1VolAdjust*myIns.getAmplitude(3) / 200;
  float yppit = myIns.getAdjustedFundAsHz(1);

  //  Input tenor2 = ins.get(3);
  //Input tenor2 = myIns.get(4);
  float ggpvol = myIns.getAmplitude(2) / volAdjust;
  //  float ggpvol = t2VolAdjust*myIns.getAmplitude(4) / 200;
  float ggppit = myIns.getAdjustedFundAsHz(2);
