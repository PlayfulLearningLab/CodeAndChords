...
public class Module_01_01_PitchHueBackgroundWBorder_EMM extends PApplet {
...
public void blur(float[] curHueArray, float[] goalHueArray, float attackTime)
{
  for (int i = 0; i < 3; i++)
  {
...
class HScrollbar {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#B7B7B7", "--stop-color=#0A0A0A", "Module_01_01_PitchHueBackgroundWBorder_EMM" };
    if (passedArgs != null) {
